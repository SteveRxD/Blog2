...
```{r, echo = F}
#NOTES
# given the time required to render these maps, and issues rendering to blogdown,
# all the leaflet maps below are first saved as standalone html files. These are 
# then published as iframes, rather than rendering the leaflet maps directly.
# Having been used to produce these html files, all the chunks below are 
# therefore set to eval = FALSE. 
```
...
library(sf)
library(leaflet)
library(htmlwidgets) # used to save maps locally
library(here)
...
# create html version of the map
setwd(here("static","img","post02-dallas-population"))
saveWidget(map1, "map1.html")
```
<iframe src="/img/post02-dallas-population/map1.html" width="100%" height="500"></iframe>
...
# This chunk is only run once to produce map2.html. Then set eval = FALSE
...
<iframe src="/img/post02-dallas-population/map2.html" width="100%" height="500"></iframe>
...
# create html version of the map
setwd(here("static","img","post02-dallas-population"))
saveWidget(map3, "map3.html")
```

<iframe src="/img/post02-dallas-population/map3.html" width="100%" height="500"></iframe>
...
# create html version of the map
setwd(here("static","img","post02-dallas-population"))
saveWidget(map4, "map4.html")
```
<iframe src="/img/post02-dallas-population/map4.html" width="100%" height="500"></iframe>
...
# create html version of the map
setwd(here("static","img","post02-dallas-population"))
saveWidget(map5, "map5.html")

```
<iframe src="/img/post02-dallas-population/map5.html" width="100%" height="600"></iframe>
...
# create html version of the map
setwd(here("static","img","post02-dallas-population"))
saveWidget(map6, "map6.html")
```
<iframe src="/img/post02-dallas-population/map6.html" width="100%" height="600"></iframe>
