...
We will use the same sample dataset from [mysqltutorial.org](http://www.mysqltutorial.org/) that was used in the first part of this post, as described [here](https://stevedoogue.netlify.app/post/r-and-sql-a/#the-sample-dataset). The schema is reproduced below for ease of reference:
<br>  
<br>  
